...
#TODO: figure out how to bundle  /default theme from pgu and freesansbold.ttf from pygame
...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Felix Software"
        self.author_email = "cfmcdonald@yahoo.com"
        self.copyright = "Copyright (c) 2012 Felix Software."
        ...
        self.extra_modules = ['file', 'gamemap', 'hexcrawl', 'render', 'util']
        self.exclude_modules = []
        
        #DLL Excludes
        self.exclude_dll = ['']
        #python scripts (strings) to be included, seperated by a comma
        self.extra_scripts = ['pgu', 'pgu.gui']
