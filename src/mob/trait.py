...
LIGHT = "Light unit"            # boolean  :army unit with this doesn't take damage in unsettled areas
...
STALWART = "Stalwart"           # boolean  : unit immediately after it can borrow this unit's armor value
STEALTH = "Stealth"
STUBBORN = "Stubborn"
...
tool_tip_table = {
    ...
    ELUSIVE : "if all units in group have this,\nwill always retreat after lost battle",
...
#    SUPPORT : "is target for assassins",
    ...
    REPUTATION : "modifier to reputation\n while you have this unit",
    ...
    STALWART : "next unit can borrow\nthis unit's armor value",
...
support_traits = [SUMMON, INSPIRE, HEAL, REVIVE, PATHFINDER, SUPPLY, HERO, ARMY_ATTACK, DIPLOMAT]
