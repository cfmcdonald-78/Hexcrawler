...
SETTLED_PLAIN = HexType("Settled Plain", 3, None, settled=True)
FOREST = HexType("Forest", 4, None, regrowth_chance=0.02)
HILL = HexType("Hill", 4, None)
SETTLED_HILL = HexType("Settled Hill", 4, None, settled=True)
MOUNTAIN = HexType("Mountain", 5, trait.MOUNTAINEER)
OCEAN = HexType("Ocean", BASE_MOVE_COST, trait.NAVAL)
DESERT = HexType("Desert", 3, trait.SUPPLY)
DESERT_HILL = HexType("Desert Hill", 4, trait.SUPPLY) 
